...
func TestKrypter(t *testing.T) {
	...
	tests := []test{
		...
		{inputMessage: []rune("Kjevik;SN39040;18.03.2022 01:50;6"), chiffer: 4, want: []rune("OnizmocXR7;484c5: 47 6466d45b94c.")},
		{inputMessage: []rune("OnizmocXR7;484c5: 47 6466d45b94c."), chiffer: len(ALF_SEM03) - 4, want: []rune("Kjevik;SN39040;18.03.2022 01:50;6")},
	}
